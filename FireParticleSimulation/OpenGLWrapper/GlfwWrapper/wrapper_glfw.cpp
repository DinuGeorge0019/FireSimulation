...
GLuint GLWrapper::LoadShader(const char * vertexShaderPath, const char * fragmentShaderPath)
{
	...
	//	Build shaders
	vertexShader = BuildShader(GL_VERTEX_SHADER, vertexShaderStr);
	fragmentShader = BuildShader(GL_FRAGMENT_SHADER, fragmentShaderStr);
	...
	// Delete the loaded shaders as they are linked to the program 
...
/* Load vertex and fragment shader and return the compiled program */
GLuint GLWrapper::LoadShader(const char* vertexShaderPath, const char* fragmentShaderPath, const char* geometryShaderFile)
{
	...
	std::string vertexShaderStr = readFile(vertexShaderPath);
	std::string fragmentShaderStr = readFile(fragmentShaderPath);
	std::string geometryShaderStr = readFile(geometryShaderFile);
	...
	vertexShader = BuildShader(GL_VERTEX_SHADER, vertexShaderStr);
	fragmentShader = BuildShader(GL_FRAGMENT_SHADER, fragmentShaderStr);
	geometryShader = BuildShader(GL_GEOMETRY_SHADER, geometryShaderStr);
